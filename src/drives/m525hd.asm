...
.define M525HD_STATE_INIT           0x0000
...
.error_lookup:
    DAT DRIVE_ERROR_NONE
    DAT DRIVE_ERROR_BUSY
    DAT DRIVE_ERROR_BAD_ADDRESS
    DAT DRIVE_ERROR_PROTECTED
    DAT DRIVE_ERROR_INTERNAL
    DAT DRIVE_ERROR_BAD_SECTOR
    DAT DRIVE_ERROR_BROKEN

.state_lookup:
    DAT DRIVE_STATE_BUSY
    DAT DRIVE_STATE_READY
    DAT DRIVE_STATE_READY_WP
    DAT DRIVE_STATE_BUSY
    DAT DRIVE_STATE_READY
